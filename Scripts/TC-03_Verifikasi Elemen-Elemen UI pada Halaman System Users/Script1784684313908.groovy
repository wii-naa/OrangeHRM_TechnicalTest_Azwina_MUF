...
WebUI.verifyEqual(WebUI.findWebElement(obj).isDisplayed(), expected_visible.asBoolean())

WebUI.verifyEqual(WebUI.findWebElement(obj).isEnabled(), expected_enabled.asBoolean())